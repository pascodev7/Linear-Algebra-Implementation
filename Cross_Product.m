...
%     SECTION: Vectors
%     THEME: Vector cross product
%    STUDENT: Pascal Jeanty
%
%%
...
% MATLAB's cross production function
v3a = cross(v2, v1);
...
h = ezmesh( @(s,t)v1(1)*s+v2(1)*t, @(s,t)v1(2)*s+v2(2)*t,
            @(s,t)v1(3)*s+v2(3)*t, [-1 1 -1 1]*2);
